function [dot_x] = rhsAngle(x, t, params)
    ...
    switch lower(params.angParametrization)
        ...
        case 'cosinemat'
            A = orthogonalize(x(1:3, 1:3)); % ortogonolization
            M = (cross([0;0;-1],A * [0;0;-1]) * params.m * param.g * params.l) * double(isequal(params.integralsEvent,'lagrange'));
            omega = x(4:6, 1);
        ...
        case 'quat'
            ...
            M = (cross([0;0;-1],quat2cosineMat(quat) * [0;0;-1]) * params.m * params.g * params.l) * double(isequal(params.integralsEvent,'lagrange'));
            omega = x(5:7, 1);
            omega_quat = [0; omega];
